...
export class AuthInterceptor implements HttpInterceptor {
    ...
    intercept(req: HttpRequest<any>, next: HttpHandler) {
        ...
        if ((req.url.includes('i18n') || req.url.includes('login') || req.url.includes('recover_key') || req.url.includes('email/feedback') || req.url.includes('register') || req.url.includes('practice') || req.url.includes('area')) && !req.url.includes('student_course')) {
